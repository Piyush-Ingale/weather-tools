...
# ARG weather_tools_git_rev=test-beam-latest-deps
...
RUN apt-get update && apt-get install -y libeccodes-dev libeccodes0 libproj-dev libgeos-dev && rm -rf /var/lib/apt/lists/*
